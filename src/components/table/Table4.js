...
import ChartAccResult from "../chart/ChartAccResult.js";
import ChartDataComponent from "../chart/ChartDataComponent.js";

import NewTable from "./NewTable.js";
import { Dropdown } from "../basic/Dropdown";

import { updatePocketsmithData } from "../../helpers/Pocketsmith.js";
import * as Pocketsmith from "../../helpers/Pocketsmith.js";
import { getCol } from "../../helpers/utils.js";
...
const App = (props) => {
  ...
  const cb2 = useCallback((e) => {
    console.log("cb2");
    /* setRedraw2(redraw2+1); */ setSearchData(e);
  }, []);
        ...
        if (props.data.length > 0) {
          setFilteredData(
            props.data.filter((element) => {
              return element.is_transfer == false || !element.is_transfer;
            })
          );
        }
      }
  ...
  const cols = useRef({
    ...
    show: [
      ...
      "transaction_account.currency_code",
    ],
    custom: {
      "category.title": {
    ...
    resp = (
      <div>
        ...
        <Newchartmemo
          ...
          type="column"
          slider
          /* setSliderData={sliderdata} */ setSliderData2={setsliderdata}
          sliderdata2={
            sliderdata
          } /* redraw={redraw2}  */ /* setRedraw={setRedraw2} */
        />
        <Newtablememo
          key="NewTable2"
          set_search_data={cb2}
